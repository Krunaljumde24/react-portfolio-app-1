...
import logoPath from "../assets/tech/springboot.png";
  ...
  return (
    <div className="w-full dark:bg-emerald-950">
      <div className="w-4/5 mx-auto py-10">
        <h2 className="text-3xl font-bold text-center pb-10 dark:text-white">Skills</h2>
        <div className="flex flex-wrap justify-center gap-4">
          {skills.map((item, index) => {
            let imgPath = `${import.meta.env.BASE_URL}src/assets/tech/${
              item.imgFileName
            }`;
            return (
              <div
